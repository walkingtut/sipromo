...
import modelPenyerapan from './Model/KelolaSwakelolaPenyerapanModel';
...
export default class KelolaSwakelolaPenyerapan extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                    title="Daftar Paket Kegiatan Swakelola - Kelola Rencana Penyerapan Anggaran"
                    store={this.store}
                    plugins={{
