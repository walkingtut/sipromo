...
import modelJadwal from './Model/KelolaSwakelolaJadwalModel';
...
export default class KelolaSwakelolaJadwal extends Component {
        ...
        return (
            ...
            >
                 <Container 
                        ...
                        height="550"
                    > 
                    <Grid title="Jadwal Paket Kegiatan" store={this.storeGrid} shadow grouped flex="7" height="450">
