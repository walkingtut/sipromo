...
import modelTahapan from './Model/KelolaKontraktualTahapanModel';
...
export default class KelolaKontraktualTahapan extends Component {
    ...
    storeGrid = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: 'resources/data/PaketTahapanData.json'
        } 
    });
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Kontraktual - Kelola Tahapan Kegiatan"
                store={this.store}
                plugins={{
