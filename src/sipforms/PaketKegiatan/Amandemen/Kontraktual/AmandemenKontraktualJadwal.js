...
import modelJadwal from './Model/AmandemenKontraktualJadwalModel';
...
export default class AmandemenKontraktualJadwal extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Kontraktual - Amandemen Jadwal Kegiatan"
                store={this.store}
                plugins={{
