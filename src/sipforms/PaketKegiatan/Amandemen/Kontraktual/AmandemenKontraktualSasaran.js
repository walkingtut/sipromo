...
import modelSasaran from './Model/AmandemenKontraktualSasaranModel';
...
export default class AmandemenKontraktualSasaran extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Kontraktual - Amandemen Sasaran Paket Kegiatan"
                store={this.store}
                plugins={{
