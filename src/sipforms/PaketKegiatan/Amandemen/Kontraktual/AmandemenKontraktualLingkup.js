...
import modelLingkup from './Model/AmandemenKontraktualLingkupModel';
...
export default class AmandemenKontraktualLingkup extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Kontraktual - Amandemen Ruang Lingkup Paket Kegiatan"
                store={this.store}
                plugins={{
