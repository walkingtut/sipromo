...
import modelTimTeknis from './Model/AmandemenKontraktualTimTeknisModel';
...
export default class AmandemenKontraktualTimTeknis extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Kontraktual - Amandemen Data Tim Teknis"
                store={this.store}
                plugins={{
