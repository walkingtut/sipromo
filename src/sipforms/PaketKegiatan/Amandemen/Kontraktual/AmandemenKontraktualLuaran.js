...
import modelLuaran from './Model/AmandemenKontraktualLuaranModel';
...
export default class AmandemenKontraktualLuaran extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Kontraktual - Amandemen Luaran Paket Kegiatan"
                store={this.store}
                plugins={{
