...
import modelTujuan from './Model/AmandemenKontraktualTujuanModel';
...
export default class AmandemenKontraktualTujuan extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Kontraktual - Amandemen Tujuan Paket Kegiatan"
                store={this.store}
                plugins={{
