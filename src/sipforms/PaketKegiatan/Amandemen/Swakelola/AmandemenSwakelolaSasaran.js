...
import modelSasaran from './Model/AmandemenSwakelolaSasaranModel';
...
export default class AmandemenSwakelolaSasaran extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Swakelola - Amandemen Sasaran Paket Kegiatan"
                store={this.store}
                plugins={{
