...
import modelLuaran from './Model/AmandemenSwakelolaLuaranModel';
...
export default class AmandemenSwakelolaLuaran extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Swakelola - Amandemen Luaran Paket Kegiatan"
                store={this.store}
                plugins={{
