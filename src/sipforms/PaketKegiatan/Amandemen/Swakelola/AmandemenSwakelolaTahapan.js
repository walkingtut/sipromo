...
import modelTahapan from './Model/AmandemenSwakelolaTahapanModel';
...
export default class AmandemenSwakelolaTahapan extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Swakelola - Amandemen Tahapan Paket Kegiatan"
                store={this.store}
                plugins={{
