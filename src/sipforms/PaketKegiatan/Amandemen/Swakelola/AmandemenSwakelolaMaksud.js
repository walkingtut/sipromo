...
import modelMaksud from './Model/AmandemenSwakelolaMaksudModel';
...
export default class AmandemenSwakelolaMaksud extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Swakelola - Amandemen Maksud Paket Kegiatan"
                store={this.store}
                grouped
                plugins={{
