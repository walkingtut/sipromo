...
import modelPenyerapan from './Model/AmandemenSwakelolaPenyerapanModel';
...
export default class AmandemenSwakelolaPenyerapan extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Swakelola - Amandemen Rencana Penyerapan Anggaran"
                store={this.store}
                plugins={{
