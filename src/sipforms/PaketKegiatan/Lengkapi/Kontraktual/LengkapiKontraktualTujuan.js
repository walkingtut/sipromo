...
import modelTujuan from './Model/LengkapiKontraktualTujuanModel';
...
export default class LengkapiKontraktualTujuan extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Kontraktual - Lengkapi Data Tujuan Kegiatan"
                store={this.store}
                plugins={{
