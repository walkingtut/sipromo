...
import modelSasaran from './Model/LengkapiSwakelolaSasaranModel';
...
export default class LengkapiSwakelolaSasaran extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Swakelola - Melengkapi Data Sasaran Kegiatan"
                store={this.store}
                plugins={{
