...
import modelTujuan from './Model/LengkapiSwakelolaTujuanModel';
...
export default class LengkapiSwakelolaTujuan extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Swakelola - Melengkapi Data Tujuan Kegiatan"
                store={this.store}
                plugins={{
