...
import modelTenagaAhli from './Model/LengkapiSwakelolaTenagaAhliModel';
...
export default class LengkapiSwakelolaTenagaAhli extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Swakelola - Melengkapi Data Tenaga Ahli"
                store={this.store}
                plugins={{
