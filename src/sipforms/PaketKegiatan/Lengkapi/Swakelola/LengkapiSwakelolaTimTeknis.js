...
import modelTimTeknis from './Model/LengkapiSwakelolaTimTeknisModel';
...
export default class LengkapiSwakelolaTimTeknis extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Grid
                title="Daftar Paket Kegiatan Swakelola - Melengkapi Data Tim Teknis"
                store={this.store}
                plugins={{
